...
`ValenceControl.PackageManifests` defines the manifest wire contract shared by manifest generation, catalog ingestion, runtime validation, and Runtime Builder tooling.
