...
using Elsa.Specifications.PackageManifest.Generator.Core.Generation;

namespace Elsa.Specifications.PackageManifest.Generator.Core.AssemblyInspection;
...
public sealed class FeatureMetadataReader
{
    ...
    public SettingHintMetadata ReadSettingMetadata(PropertyInfo property)
    {
        var hint = property.GetCustomAttributesData()
            .FirstOrDefault(x => x.AttributeType.FullName == "Elsa.Specifications.PackageManifest.Generator.Hints.ManifestSettingAttribute");
    ...
    private static IReadOnlyList<ManifestUIOptionReference> ReadUIOptions(MemberInfo member)
    {
        return member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "Elsa.Specifications.PackageManifest.Generator.Hints.ManifestUIOptionAttribute")
    ...
    private static ManifestUIOptionsProviderReference? ReadUIOptionsProvider(MemberInfo member)
    {
        var attribute = member.GetCustomAttributesData()
            .FirstOrDefault(x => x.AttributeType.FullName == "Elsa.Specifications.PackageManifest.Generator.Hints.ManifestUIOptionsProviderAttribute");
    ...
    private static IReadOnlyList<string> ReadFeatureCategoryAttributes(MemberInfo member) =>
        NormalizeCategories(member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "Elsa.Specifications.PackageManifest.Generator.Hints.ManifestFeatureCategoryAttribute")
    ...
    {
        return member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "Elsa.Specifications.PackageManifest.Generator.Hints.ManifestInfrastructureAttribute")
