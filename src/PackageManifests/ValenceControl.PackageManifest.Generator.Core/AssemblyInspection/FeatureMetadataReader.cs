...
{
    private const string ManifestRuntimeKindAttributeName = "ValenceControl.PackageManifest.Generator.Hints.ManifestRuntimeKindAttribute";
    ...
    public SettingHintMetadata ReadSettingMetadata(PropertyInfo property)
    {
        var hint = property.GetCustomAttributesData()
            .FirstOrDefault(x => x.AttributeType.FullName == "ValenceControl.PackageManifest.Generator.Hints.ManifestSettingAttribute");
    ...
    private static IReadOnlyList<ManifestUIOptionReference> ReadUIOptions(MemberInfo member)
    {
        return member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "ValenceControl.PackageManifest.Generator.Hints.ManifestUIOptionAttribute")
    ...
    private static ManifestUIOptionsProviderReference? ReadUIOptionsProvider(MemberInfo member)
    {
        var attribute = member.GetCustomAttributesData()
            .FirstOrDefault(x => x.AttributeType.FullName == "ValenceControl.PackageManifest.Generator.Hints.ManifestUIOptionsProviderAttribute");
    ...
    {
        return member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "ValenceControl.PackageManifest.Generator.Hints.ManifestExtensionAttribute")
            .Select(x => new
            {
    ...
    private static IReadOnlyList<string> ReadFeatureCategoryAttributes(MemberInfo member) =>
        NormalizeCategories(member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "ValenceControl.PackageManifest.Generator.Hints.ManifestFeatureCategoryAttribute")
    ...
    {
        return member.GetCustomAttributesData()
            .Where(x => x.AttributeType.FullName == "ValenceControl.PackageManifest.Generator.Hints.ManifestInfrastructureAttribute")
