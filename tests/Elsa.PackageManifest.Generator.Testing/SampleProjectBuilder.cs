...
public sealed class SampleProjectBuilder : IAsyncDisposable
{
    ...
    private string RenderProject()
    {
        ...
        var propsImport = _useLocalGeneratorPackage
            ? """  <Import Project=".generator/build/Elsa.PackageManifest.Generator.props" />"""
            : "";
        var targetsImport = _useLocalGeneratorPackage
            ? """  <Import Project=".generator/build/Elsa.PackageManifest.Generator.targets" />"""
            : "";
...
""");
    ...
    private void WriteLocalGeneratorPackage()
    {
        ...
        File.Copy(FindRepositoryFile("src/Elsa.PackageManifest.Generator/build/Elsa.PackageManifest.Generator.props"), Path.Combine(buildDirectory, "Elsa.PackageManifest.Generator.props"), true);
