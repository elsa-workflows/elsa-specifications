...
namespace Elsa.Specifications.PackageManifest.Generator.Testing;
...
public sealed class SampleProjectBuilder : IAsyncDisposable
{
    ...
    private string RenderProject()
    {
        ...
        var propsImport = _useLocalGeneratorPackage
            ? """  <Import Project=".generator/build/Elsa.Specifications.PackageManifest.Generator.props" />"""
            : "";
        var targetsImport = _useLocalGeneratorPackage
            ? """  <Import Project=".generator/build/Elsa.Specifications.PackageManifest.Generator.targets" />"""
            : "";
...
""");
    ...
    private void WriteLocalGeneratorPackage()
    {
        ...
        File.Copy(FindRepositoryFile("src/Elsa.Specifications.PackageManifest.Generator/build/Elsa.Specifications.PackageManifest.Generator.props"), Path.Combine(buildDirectory, "Elsa.Specifications.PackageManifest.Generator.props"), true);
        File.Copy(FindRepositoryFile("src/Elsa.Specifications.PackageManifest.Generator/build/Elsa.Specifications.PackageManifest.Generator.targets"), Path.Combine(buildDirectory, "Elsa.Specifications.PackageManifest.Generator.targets"), true);
    ...
    private static bool IsGeneratorTaskAsset(string path)
    {
        ...
        return string.Equals(extension, ".json", StringComparison.OrdinalIgnoreCase) &&
               Path.GetFileName(path).StartsWith("Elsa.Specifications.PackageManifest.Generator.", StringComparison.Ordinal);
    }
